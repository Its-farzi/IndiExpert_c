...
int main()
{
    ...
    // Menu Display
    printf("|S. No.|\t\tItem Name\t|\tPrice\t|\t\tAbout\t\t\t\t     |");
    printf("\n----------------------------------------------------------------------------------------------------");
    printf("\n| 1.|\t   Grilled Chicken Steak\t|\t450\t|  Served with vegetables and sauce.                 |\n");
    printf("\n-----------------------------------------------------------------------------------------");
    printf("\n| 2.|\t   Spaghetti Bolognese\t\t|\t250\t|  Pasta with meat-based tomato sauce.               |\n");
    printf("\n-----------------------------------------------------------------------------------------");
    printf("\n| 3.|\t  Fish and Chips\t\t|\t350\t| Fried fish served with crispy fries.               |\n");
    printf("\n-----------------------------------------------------------------------------------------");
    printf("\n| 4.|\t  Beef Stroganoff\t\t|\t400\t| Beef cooked in creamy mushroom sauce.              |\n");
    printf("\n-----------------------------------------------------------------------------------------");
    printf("\n| 5.|\t  Caesar Salad  \t\t|\t230\t| Salad with lettuce, croutons, cheese, and dressing.|\n");
    printf("\n-----------------------------------------------------------------------------------------");
    printf("\n| 6.|\t   Full Meal \t\t\t|\t1500\t|  *** All Mentioned Dishes Included ***             |\n");
    printf("\n-----------------------------------------------------------------------------------------");
